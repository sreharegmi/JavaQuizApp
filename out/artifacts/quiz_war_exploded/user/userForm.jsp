    ...
    <div id="templatemo_wrapper_inner">
        ...
        <div id="templatemo_content_wrapper">
            ...
            <div id="templatemo_content">
                ...
                <table>
                    <tr>
                        <th>User Name</th><td><input type="text" name="username"  required="required"></td>
                    </tr>

                    <tr>
                        <th>Password</th><td><input type="text" name="password"  required="required"></td>
                    </tr>

                    <tr>
                        <th>Role</th><td><input type="text" name="role"  required="required"></td>
                    </tr>

                    <tr>
                        <th colspan="2"><input type="submit" value="Add User"  required="required"></th>
                    </tr>
